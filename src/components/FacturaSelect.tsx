...
export default function FacturaSelect({ items, value, onChange, placeholder = "Buscar...", maxHeightClass = "max-h-48", className = "", label, }: Props) {
  ...
  return (
    <div className={`relative ${className}`} ref={containerRef}>
      ...
      <input
        className="w-full bg-white/5 text-white/90 rounded-md px-3 py-2"
